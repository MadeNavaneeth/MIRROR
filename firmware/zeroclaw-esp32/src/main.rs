//! Mirror ESP32 firmware — JSON-over-serial peripheral.
//!
//! Listens for newline-delimited JSON commands on UART0, executes gpio_read/gpio_write,
//! responds with JSON. Compatible with host Mirror SerialPeripheral protocol.
//!
...
fn main() -> anyhow::Result<()> {
    ...
    info!("Mirror ESP32 firmware ready on UART0 (115200)");
