//! Example: Implementing a custom Memory backend for Mirror
//!
...
// ── Re-define the trait types (in your app, import from mirror::memory) ──
...
async fn main() -> anyhow::Result<()> {
    ...
    println!("🧠 Mirror Memory Demo — InMemoryBackend\n");
