# Audit Logging for Mirror

## Problem
Mirror logs actions but lacks tamper-evident audit trails for:
...
# Tamper evidence
sign_events = true
signing_key_path = "~/.config/mirror/audit.key"
...
mirror audit --user @alice

# Show all high-risk commands
mirror audit --risk high

# Show violations from last 24 hours
mirror audit --since 24h --violations-only

# Export to JSON for analysis
mirror audit --format json --output audit.json
