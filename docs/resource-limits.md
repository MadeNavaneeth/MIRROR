# Resource Limits for Mirror

## Problem
Mirror has rate limiting (20 actions/hour) but no resource caps. A runaway agent could:
...
Automatically create a cgroup for mirror with limits.
