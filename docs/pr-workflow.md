# Mirror PR Workflow (High-Volume Collaboration)

This document defines how Mirror handles high PR volume while maintaining:
...
- If identity-like wording appears in tests/examples, it is normalized to Mirror/project-native labels.
...
- Confirm any required identity-like wording uses Mirror/project-native terminology.
