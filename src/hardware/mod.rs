...
/// Handle `mirror hardware` subcommands.
#[allow(clippy::module_name_repetitions)]
pub fn handle_command(_cmd: crate::HardwareCommands, _config: &Config) -> Result<()> {
...
fn run_info(chip: &str) -> Result<()> {
    ...
    #[cfg(not(feature = "probe"))]
    {
        ...
        println!();
        println!("Then run: mirror hardware info --chip {}", chip);
        println!();
