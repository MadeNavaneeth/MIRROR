...
pub use mirror_event::MirrorEventTool;
...
pub fn all_tools_with_runtime(
    ...
    let mut tools: Vec<Box<dyn Tool>> = vec![
        ...
        Box::new(MirrorEventTool::new(security.clone())),
        Box::new(GogTool::new(
            security.clone(),
            Arc::new(crate::auth::handler::AuthHandler::new(
                config.clone(),
                Arc::new(crate::auth::storage::CredentialStorage::new(
                    workspace_dir.join("credentials.json"),
