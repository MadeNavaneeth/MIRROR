...
const SNAPSHOT_HEADER: &str = "# 🧠 Mirror Memory Snapshot\n\n\
    > Auto-generated by Mirror. Do not edit manually unless you know what you're doing.\n\
...
mod tests {
    ...
    fn parse_snapshot_basic() {
        let input = r#"# 🧠 Mirror Memory Snapshot

> Auto-generated by Mirror.
...
I am Mirror, a self-preserving AI agent.
...
"#;
    ...
    fn parse_snapshot_empty() {
        let input = "# 🧠 Mirror Memory Snapshot\n\n> Nothing here.\n";
        let entries = parse_snapshot(input);
